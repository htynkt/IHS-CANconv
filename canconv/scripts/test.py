...
def run_test(model_name, weight_file, test_dataset="reduced", cfg=None, preset=None, override=None, output_dir=None):
    ...
    if test_dataset == "reduced":
        dataset = H5PanDataset(cfg["test_reduced_data"], scale=2047)
...
if __name__ == "__main__":
    ...
    parser.add_argument("model_name", type=str,default='cannet')
    parser.add_argument("weight_file", type=str,default='runs/cannet_wv3/weights/300.pth')
