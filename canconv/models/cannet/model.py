...
from canconv.models.cannet.IHS import *
...
class CANNet(nn.Module):
    def __init__(self, spectral_num=8, channels=32, cluster_num=32, filter_threshold=0.005, *args, **kwargs) -> None:
        ...
        self.tail_conv = nn.Conv2d(channels, 1, 3, 1, 1)
        # added by Yan
        self.last_conv = nn.Conv2d(channels, spectral_num, 3, 1, 1)

        # 定义一个形状为 (batch_size, channels, height, width) 的参数
        self.custom_param = nn.Parameter(torch.randn(32, spectral_num, 64, 64))
